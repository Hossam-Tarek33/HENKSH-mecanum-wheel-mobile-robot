...
if("TRUE" STREQUAL "TRUE")
  set(mpu6050_SOURCE_PREFIX /home/hossam/catkin_ws/src/ros-mpu6050-node-master)
  set(mpu6050_DEVEL_PREFIX /home/hossam/catkin_ws/devel)
  set(mpu6050_INSTALL_PREFIX "")
  set(mpu6050_PREFIX ${mpu6050_DEVEL_PREFIX})
else()
  set(mpu6050_SOURCE_PREFIX "")
  set(mpu6050_DEVEL_PREFIX "")
  set(mpu6050_INSTALL_PREFIX /home/hossam/catkin_ws/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'mpu6050' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/hossam/catkin_ws/src/ros-mpu6050-node-master/${idir}'.  ${_report}")
    endif()
